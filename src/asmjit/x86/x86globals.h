...
struct Inst : public BaseInst {
  ...
  enum Id : uint32_t {
    ...
    kIdVpdpbusd,                         //!< Instruction 'vpdpbusd' {AVX512_VNNI|AVX_VNNI+VL}.
    kIdVpdpbusds,                        //!< Instruction 'vpdpbusds' {AVX512_VNNI|AVX_VNNI+VL}.
    kIdVpdpwssd,                         //!< Instruction 'vpdpwssd' {AVX512_VNNI|AVX_VNNI+VL}.
    kIdVpdpwssds,                        //!< Instruction 'vpdpwssds' {AVX512_VNNI|AVX_VNNI+VL}.
